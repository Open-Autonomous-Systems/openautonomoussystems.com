export const LP_GRID_ITEMS = [
  {
    title: "Smart Modules",
    description: "Size, Weight, and Power Constrained (SWaP-C) embedded modules geared for robust autonomy.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: "Download our Opensource software and hardware designs to kickstart your next project.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
