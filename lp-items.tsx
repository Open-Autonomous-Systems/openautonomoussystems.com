export const LP_GRID_ITEMS = [
  {
    title: "SafeOpsia AI",
    description: "Transforming workplace compliance and safety with advanced Vision AI solutions",
    icon: (
  ...
  {
    title: "SafeOpsia Dashboard",
    description: "Analytical dashboard for SafeOpsia AI",
    icon: (
      <svg xmlns="" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
